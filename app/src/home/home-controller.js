...
angular.module('voyager.home')
	.controller('HomeCtrl', function(config, $scope, $window, $location, $modal, homeService, authService, leafletData, filterService, searchService, savedSearchService, sugar, configService, savedSearchQuery) {
